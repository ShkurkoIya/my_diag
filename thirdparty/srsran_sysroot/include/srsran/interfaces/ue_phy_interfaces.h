...
struct phy_args_t {
  ...
  std::vector<uint32_t> dl_earfcn_list = {
      3400};  // vectorized version of dl_earfcn that gets populated during init
...
class phy_interface_stack_lte
    : public phy_interface_mac_lte
    , public phy_interface_rrc_lte {};

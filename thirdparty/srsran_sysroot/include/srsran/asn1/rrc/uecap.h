...
struct ue_radio_paging_info_r12_s {
  ...
  typedef enumerated<wake_up_signal_min_gap_e_drx_tdd_r15_opts>
...
// NonContiguousUL-RA-WithinCC-List-r10 ::= SEQUENCE (SIZE (1..64)) OF
...
struct phy_layer_params_v1530_s {
  struct stti_spt_cap_r15_s_ {
    ...
    typedef enumerated<max_layers_slot_or_subslot_pusch_r15_opts>
...
// SupportedBandCombinationReduced-v1320 ::= SEQUENCE (SIZE (1..384)) OF
...
// SupportedBandCombinationReduced-v1380 ::= SEQUENCE (SIZE (1..384)) OF
...
// SupportedBandCombinationReduced-v1390 ::= SEQUENCE (SIZE (1..384)) OF
...
// SupportedBandCombinationReduced-v1430 ::= SEQUENCE (SIZE (1..384)) OF
...
// SupportedBandCombinationReduced-v1450 ::= SEQUENCE (SIZE (1..384)) OF
...
// SupportedBandCombinationReduced-v1470 ::= SEQUENCE (SIZE (1..384)) OF
...
// SupportedBandCombinationReduced-v14b0 ::= SEQUENCE (SIZE (1..384)) OF
...
// SupportedBandCombinationReduced-v1530 ::= SEQUENCE (SIZE (1..384)) OF
...
// SupportedBandCombinationReduced-v1610 ::= SEQUENCE (SIZE (1..384)) OF
...
// SupportedBandCombinationReduced-v1630 ::= SEQUENCE (SIZE (1..384)) OF
...
// V2X-SupportedBandCombination-r14 ::= SEQUENCE (SIZE (1..384)) OF
...
// V2X-SupportedBandCombination-v1530 ::= SEQUENCE (SIZE (1..384)) OF
...
// V2X-SupportedBandCombinationEUTRA-NR-r16 ::= SEQUENCE (SIZE (1..512)) OF
...
using v2x_supported_band_combination_eutra_nr_v1630_l =
    dyn_array<v2x_band_combination_params_eutra_nr_v1630_s>;
...
// V2X-BandCombinationParametersEUTRA-NR-v1710 ::= SEQUENCE (SIZE (1..64)) OF
...
using v2x_supported_band_combination_eutra_nr_v1710_l =
    dyn_array<v2x_band_combination_params_eutra_nr_v1710_l>;
...
struct sl_params_v1710_s {
  ...
  v2x_supported_band_combination_eutra_nr_v1710_l
      v2x_supported_band_combination_list_eutra_nr_v1710;
...
struct ntn_params_v1720_s {
  ...
  typedef enumerated<ntn_segmented_precompensation_gaps_r17_opts>
      ntn_segmented_precompensation_gaps_r17_e_;
...
struct rf_params_v1570_s {
  ...
  typedef enumerated<dl_minus1024_qam_scaling_factor_r15_opts>

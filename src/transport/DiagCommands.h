...
constexpr uint32_t WCDMA_CELL_ID = 0x127;              // 0x4127
...
public:
  ...
  /// Full scat `log_mask_scat_lte` (RRC+NAS+MAC layers) + ML1 search codes.
  bool set_lte_mask() {
    return send_set_mask(DiagEquip::LTE, 0x09FF,
                         {
                             DiagItem::LTE_MAC_RACH_TRIGGER,
                             DiagItem::LTE_MAC_RACH_RESPONSE,
                             DiagItem::LTE_MAC_DL_TB,
                             DiagItem::LTE_MAC_UL_TB,
                             DiagItem::LTE_ML1_MAC_RAR_MSG1,
                             DiagItem::LTE_ML1_MAC_RAR_MSG2,
                             DiagItem::LTE_ML1_MAC_MSG3,
                             DiagItem::LTE_ML1_MAC_MSG4,
                             DiagItem::LTE_ML1_CONN_INTRA_MEAS,
                             DiagItem::LTE_ML1_SERVING_MEAS,
                             DiagItem::LTE_ML1_NEIGHBOR_MEAS,
                             DiagItem::LTE_ML1_INTRA_RESEL,
                             DiagItem::LTE_ML1_NEIGHBOR_MEAS_REQ,
                             DiagItem::LTE_ML1_SERVING_MEAS_RSP,
                             DiagItem::LTE_ML1_SEARCH_REQ_RSP,
                             DiagItem::LTE_ML1_CONN_NEIGH_MEAS,
                             DiagItem::LTE_ML1_SERVING_INFO,
                             DiagItem::LTE_RRC_OTA,
                             DiagItem::LTE_RRC_MIB,
                             DiagItem::LTE_RRC_SERVING_CELL,
                             DiagItem::LTE_RRC_PLMN_SEARCH_REQ,
                             DiagItem::LTE_RRC_PLMN_SEARCH_RSP,
                             DiagItem::LTE_RRC_LOG_MEAS,
                             DiagItem::LTE_RRC_PAGING,
                             DiagItem::LTE_RRC_CA_COMBOS,
                             DiagItem::LTE_LL1_PSS_RESULTS,
                             DiagItem::LTE_LL1_SSS_RESULTS,
                             DiagItem::LTE_LL1_NCELL_CER,
                             DiagItem::LTE_CELL_INFO_MIB,
                             DiagItem::LTE_INITIAL_ACQ,
                             DiagItem::LTE_NAS_ESM_SEC_IN,
                             DiagItem::LTE_NAS_ESM_SEC_OUT,
                             DiagItem::LTE_NAS_ESM_PLAIN_IN,
                             DiagItem::LTE_NAS_ESM_PLAIN_OUT,
                             DiagItem::LTE_NAS_EMM_SEC_IN,
                             DiagItem::LTE_NAS_EMM_SEC_OUT,
                             DiagItem::LTE_NAS_EMM_PLAIN_IN,
                             DiagItem::LTE_NAS_EMM_PLAIN_OUT,
                             DiagItem::NR_RRC_OTA,
                             DiagItem::NR_RRC_MIB,
                             DiagItem::NR_RRC_SERVING,
                             DiagItem::NR_RRC_CONFIG,
                             DiagItem::NR_RRC_CA,
                             DiagItem::NR_RRC_PLMN_SEARCH_REQ,
                             DiagItem::NR_RRC_PLMN_SEARCH_RSP,
                             DiagItem::NR_RRC_DETECTED_CELL,
                             DiagItem::NR_ML1_SEARCHER_ACQ,
                             DiagItem::NR_ML1_SEARCHER_MEAS_CFG,
                             DiagItem::NR_ML1_MEAS_DB,
                         });
  }
